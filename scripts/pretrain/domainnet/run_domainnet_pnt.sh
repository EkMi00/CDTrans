...
python train.py --config_file configs/pretrain.yml MODEL.DEVICE_ID "('0')" DATASETS.NAMES 'DomainNet' \
OUTPUT_DIR '../logs/pretrain/'$model'/domainnet/Painting' \
DATASETS.ROOT_TRAIN_DIR './data/domainnet/painting.txt' \
DATASETS.ROOT_TEST_DIR './data/domainnet/painting.txt'  \
